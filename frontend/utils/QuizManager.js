 ...
 * Loads quiz data from JSON files instead of individual JS modules
 */

// Quiz data imports
import washingtonQuizzes from '../assets/quizzes/washington.json';
import californiaQuizzes from '../assets/quizzes/california.json';
